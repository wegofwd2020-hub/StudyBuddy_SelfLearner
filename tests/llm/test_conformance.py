...
from pipeline.providers.contract import LLMRequest, LLMResponse, Provider
from pipeline.providers.errors import LLMSchemaError
...
class FakeProvider(Provider):
    ...
    def generate(self, req: LLMRequest) -> LLMResponse:
        ...
        return LLMResponse(text=text, provider_id="fake", model="fake-1",

...
| `USER_MANAGEMENT.md` | Before touching auth/accounts — or porting identity to another tool: design, file map, config, and the Supabase setup runbook (companion to ADR-014 / ADR-019) |
